...
with(Datawork, plot(timesmerg, Global_active_power, 
                    ...
                    xlab = ""))
# Second Graph
with(Datawork, plot(timesmerg, Voltage, 
                    ylab = "Voltage", type = "l", 
                    xlab = "datetime"))
# Third Graph
with(Datawork, {
     plot(timesmerg, Sub_metering_1, type = "l", ylab = "Energy sub metering",
          xlab = "")
     lines(timesmerg, Sub_metering_2, col = "red")
     lines(timesmerg, Sub_metering_3, col = "blue")
...
# Fourth Graph
names(Datawork)
with(Datawork, plot(timesmerg, Global_reactive_power, 
